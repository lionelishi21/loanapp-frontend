...
@Component({
    selector: 'app-interest-transaction',
    styles: [],
    templateUrl: './interest-transaction.component.html'
})
export class InterestTransactionComponent implements OnInit, AfterViewInit  {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
                ...
                private dialogRef: MatDialogRef<InterestTransactionComponent>) {

        this.interest = row.data;
    }
    ...
    ngOnInit() {
        ...
        this.transactionDataSource.load('', 0, 0, 'transaction_date', 'desc', 'loan_interest_repayments_id', this.interest.id);
    ...
    loadData() {
        this.transactionDataSource.load(
            ...
            this.sort.active,
            this.sort.direction,
            'loan_interest_repayments_id', this.interest.id
        );
    }
